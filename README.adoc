...
* Public instance, for example this one {plantuml-url}.
...
const ADOC = `
== PlantUML
:plantuml-server-url: {plantuml-url} <1>
[plantuml]
----
alice -> bob
bob ..> alice
...
<div class="imageblock"><div class="content"><img class="plantuml" src="{plantuml-url}/png/Iyp9J4vLqBLJICfFuW9Y1JqzEuL4a200"/></div></div>
</div>
</div>
----
...
asciidoc:
  ...
  attributes:
    plantuml-server-url: '{plantuml-url}' <2>
output:
  dir: build
----
